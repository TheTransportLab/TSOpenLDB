...
import { fn as GetFastestDepartures } from "./GetFastestDepartures";
...
describe("GetFastestDepartures", () => {
  before(async () => {
    result = await GetFastestDepartures({
      // @ts-ignore
    ...
    // console.log(JSON.stringify(result?.departures, null, 2));
  });
