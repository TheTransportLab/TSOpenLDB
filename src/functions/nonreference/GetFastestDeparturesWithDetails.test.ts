...
import { fn as GetFastestDeparturesWithDetails } from "./GetFastestDeparturesWithDetails";
...
describe("GetFastestDeparturesWithDetails", () => {
  before(async () => {
    result = await GetFastestDeparturesWithDetails({
      // @ts-ignore
