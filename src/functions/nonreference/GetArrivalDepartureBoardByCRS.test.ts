...
import { fn as GetArrivalDepartureBoardByCRS } from "./GetArrivalDepartureBoardByCRS";
...
describe("GetArrivalDepartureBoardByCRS", () => {
  before(async () => {
    result = await GetArrivalDepartureBoardByCRS({
      // @ts-ignore
